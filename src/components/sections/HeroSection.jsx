  ...
  useGSAP(
    () => {
      const getFallDistance = () => {
        ...
        let cupOffset;
        if (w <= 768) {
          cupOffset = Math.max(273, Math.min(w * 0.44, 280));
        } else {
          cupOffset = Math.max(245, Math.min(w * 0.288, 350));
        }
        return h - cupOffset;
      };
      ...
      scrollLeaves.forEach((leaf, idx) => {
        ...
        leavesScrollTl
          ...
          .to(
            ...
            startTime + duration,
          ); // Starts exactly when the falling tween finishes
      });
  ...
  return (
    ...
    >
      ...
      <div className="hero-steam-container" aria-hidden="true">
        <svg
          className="hero-steam-svg"
          viewBox="0 0 100 120"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <path
            className="hero-steam-wisp wisp-1"
            d="M 30,110 Q 18,75 30,45 T 25,5"
          ...
          />
          <path
            className="hero-steam-wisp wisp-2"
            d="M 42,110 Q 50,75 40,45 T 45,5"
          ...
          />
          <path
            className="hero-steam-wisp wisp-3"
            d="M 52,110 Q 60,75 52,45 T 56,5"
          ...
          />
          <path
            className="hero-steam-wisp wisp-4"
            d="M 62,110 Q 52,75 60,45 T 54,5"
            stroke="rgba(255, 255, 255, 0.85)"
            strokeWidth="7"
            strokeLinecap="round"
            fill="none"
          />
          <path
            className="hero-steam-wisp wisp-5"
            d="M 72,110 Q 62,75 70,45 T 65,5"
            stroke="rgba(255, 255, 255, 0.75)"
            strokeWidth="5"
            strokeLinecap="round"
            fill="none"
